...
cv2.createTrackbar("Sat Min", "Trackbars", 69, 255, empty)  # Saturation
cv2.createTrackbar("Sat Max", "Trackbars", 255, 255, empty)
cv2.createTrackbar("Val Min", "Trackbars", 44, 255, empty)  # Values
...
while True:
    ...
    cv2.waitKey(1)  # change to 1 to keep updating changes
